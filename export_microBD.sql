...
(1,'Empresa de Prueba','Tecnología','PRUEBA123456',NULL,NULL,NULL,'2026-02-18 17:57:15');
...
--
-- Table structure for table `feedback_contratacion`
--

DROP TABLE IF EXISTS `feedback_contratacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `feedback_contratacion` (
  `id_feedback_contratacion` int(11) NOT NULL AUTO_INCREMENT,
  `id_vinculo` int(11) NOT NULL,
  `id_subgrupo` int(10) unsigned NOT NULL,
  `id_habilidad` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id_feedback_contratacion`),
  KEY `fk_fc_vinculo` (`id_vinculo`),
  KEY `fk_fc_subgrupo` (`id_subgrupo`),
  KEY `fk_fc_habilidad` (`id_habilidad`),
  CONSTRAINT `fk_fc_habilidad` FOREIGN KEY (`id_habilidad`) REFERENCES `habilidades_clave` (`id_habilidad`),
  CONSTRAINT `fk_fc_subgrupo` FOREIGN KEY (`id_subgrupo`) REFERENCES `subgrupos_operadores` (`id_subgrupo`),
  CONSTRAINT `fk_fc_vinculo` FOREIGN KEY (`id_vinculo`) REFERENCES `vinculacion_empresa_alumno` (`id_vinculo`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `feedback_contratacion`
--

SET @OLD_AUTOCOMMIT=@@AUTOCOMMIT, @@AUTOCOMMIT=0;
LOCK TABLES `feedback_contratacion` WRITE;
/*!40000 ALTER TABLE `feedback_contratacion` DISABLE KEYS */;
INSERT INTO `feedback_contratacion` VALUES
(1,4,20,114);
/*!40000 ALTER TABLE `feedback_contratacion` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;
SET AUTOCOMMIT=@OLD_AUTOCOMMIT;
...
INSERT INTO `feedback_respuesta` VALUES
(9,3,1,4,NULL),
(10,3,2,5,NULL),
(11,3,3,4,NULL),
(12,3,4,NULL,'no sabe mysql');
...
INSERT INTO `feedback_submission` VALUES
(3,4,'2026-02-20 17:09:15');
...
(909,78,'2026-02-18 17:58:07',NULL,NULL,'activa'),
(910,78,'2026-02-18 18:04:21',NULL,NULL,'activa'),
(911,4,'2026-02-18 18:58:41',NULL,NULL,'activa'),
(912,4,'2026-02-18 19:00:09',NULL,NULL,'activa'),
(913,78,'2026-02-18 19:07:38',NULL,NULL,'activa'),
(914,76,'2026-02-19 14:57:31',NULL,NULL,'activa'),
(915,4,'2026-02-19 15:12:45',NULL,NULL,'activa'),
(916,78,'2026-02-19 15:23:41',NULL,NULL,'activa'),
(917,4,'2026-02-19 15:24:36',NULL,NULL,'activa'),
(918,78,'2026-02-19 15:25:20',NULL,NULL,'activa'),
(919,4,'2026-02-19 15:57:40',NULL,NULL,'activa'),
(920,78,'2026-02-19 16:30:26',NULL,NULL,'activa'),
(921,4,'2026-02-19 17:29:01',NULL,NULL,'activa'),
(922,78,'2026-02-19 17:29:30',NULL,NULL,'activa'),
(923,4,'2026-02-19 17:29:46',NULL,NULL,'activa'),
(924,78,'2026-02-19 17:30:02',NULL,NULL,'activa'),
(925,4,'2026-02-19 17:30:18',NULL,NULL,'activa'),
(926,78,'2026-02-19 20:30:43',NULL,NULL,'activa'),
(927,4,'2026-02-19 20:31:03',NULL,NULL,'activa'),
(928,4,'2026-02-19 20:31:25',NULL,NULL,'activa'),
(929,78,'2026-02-19 20:31:40',NULL,NULL,'activa'),
(930,4,'2026-02-19 20:31:59',NULL,NULL,'activa'),
(931,78,'2026-02-19 21:05:17',NULL,NULL,'activa'),
(932,78,'2026-02-20 15:29:00',NULL,NULL,'activa'),
(933,4,'2026-02-20 15:29:51',NULL,NULL,'activa'),
(934,4,'2026-02-20 16:59:21',NULL,NULL,'activa'),
(935,78,'2026-02-20 17:07:50',NULL,NULL,'activa'),
(936,4,'2026-02-20 17:09:48',NULL,NULL,'activa'),
(937,78,'2026-02-20 17:41:20',NULL,NULL,'activa'),
(938,4,'2026-02-20 17:41:52',NULL,NULL,'activa');
...
CREATE TABLE `universidad` (
  ...
  `logo_url` varchar(255) DEFAULT NULL,
  `tipo_periodo` enum('Semestre','Cuatrimestre') DEFAULT 'Semestre',
  `fecha_registro` timestamp NULL DEFAULT current_timestamp(),
  `fecha_actualizacion` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
(14,'Universidad Autonoma de Queretaro','UAQ123','uaq esquina uaq calle uaq','4444444444','UAQ1@gmail.com','https://maps.app.goo.gl/Cho4a1RcFjvY6dRWA','/uploads/logos/logo-1755009502925-66301552.svg','Semestre','2025-07-11 16:13:25','2025-08-21 16:35:38'),
(15,'Universidad Politecnica de Santa Rosa Jauregui','UPSRJ1','carretera san luis potosi','2222222222','upsrj@gmail.com','https://maps.app.goo.gl/E9jmxADCrYgJujT86','/uploads/logos/logo-1755185898508-292691154.png','Semestre','2025-07-16 17:53:32','2026-01-08 14:30:44'),
(16,'Instituto Tecnologico de Mexico (Campus Queretaro)','itq','conocido','4421234567','itq@qro.edu.mx','https://maps.app.goo.gl/Cho4a1RcFjvY6dRWA','/uploads/logos/logo-1755009594765-67685697.png','Semestre','2025-08-08 15:57:09','2025-08-12 14:39:54'),
(17,'UTEQ','UTEQ1','qro','','Uteeq@gmail.com','https://maps.app.goo.gl/ZyJVpKWXmaoD83kY9','/uploads/logos/logo-1767987832715-281812144.png','Semestre','2025-12-11 16:43:31','2026-01-09 19:43:52'),
(18,'UPQ','upq1','','','upq@gmail.com','','/uploads/logos/logo-1767990326409-765254268.svg','Semestre','2026-01-09 20:25:26','2026-01-09 20:25:26'),
(19,'UTC','utc1','','','utc@gmail.com','','/uploads/logos/logo-1767990655295-757673018.png','Semestre','2026-01-09 20:29:52','2026-01-09 20:30:55'),
(20,'UTSJR','utsjr1','','','utsjr@gmail.com','','/uploads/logos/logo-1767990925578-868131509.png','Semestre','2026-01-09 20:35:25','2026-01-09 20:35:25'),
(21,'TECNM Campus Queretaro','tecnm1','','','tecnmqro1@gmail.com','','/uploads/logos/logo-1767991197689-484140443.png','Semestre','2026-01-09 20:39:57','2026-01-09 20:39:57'),
(22,'TECNM San Juan del Rio','tecnmSJR1','','','tecnmSjr1@gmail.com','','/uploads/logos/logo-1767991472260-236972642.png','Semestre','2026-01-09 20:44:32','2026-01-09 20:44:32'),
(23,'Universidad Cuauhtemoc','cuauhtemoc1','','','cuauhtemoc1@gmail.com','','/uploads/logos/logo-1767991970411-63814335.png','Semestre','2026-01-09 20:48:48','2026-01-09 20:52:50'),
(24,'UNIQ','uniq1','','','uniq1@gmail.com','','/uploads/logos/logo-1767992618948-40661802.png','Semestre','2026-01-09 20:59:47','2026-01-09 21:03:38'),
(25,'UVM','uvm1','','','uvm1@gmail.com','','/uploads/logos/logo-1767992838424-154796346.png','Semestre','2026-01-09 21:07:18','2026-01-09 21:07:18'),
(26,'UNAQ','UNAQ1','','','UNAQ@gmail.com','','/uploads/logos/logo-1768230127633-71015569.png','Semestre','2026-01-12 15:01:59','2026-01-12 15:02:07'),
(27,'UNICEQ','Uniceq1','','','Uniceq1@gmail.com','','/uploads/logos/logo-1768231235994-227334738.png','Semestre','2026-01-12 15:20:35','2026-01-12 15:20:35'),
(28,'CESBA','Cesba1','','4421212121','Cesba1@gmail.com','','/uploads/logos/logo-1768593834017-550406721.png','Semestre','2026-01-12 15:21:12','2026-01-16 20:12:09'),
(29,'Universidad de Londres','londresQro1','','','londres1Qro@gmail.com','','/uploads/logos/logo-1768231319339-225282275.png','Semestre','2026-01-12 15:21:59','2026-01-12 15:21:59'),
(30,'UNIPLEA','Uniplea1','','','Uniplea@gmail.com','','/uploads/logos/logo-1768231362375-435538280.png','Semestre','2026-01-12 15:22:42','2026-01-12 15:22:42'),
(31,'DICORMO','Dicormo1','','','Dicormo1@gmail.com','','/uploads/logos/logo-1768231407105-290301575.png','Semestre','2026-01-12 15:23:27','2026-01-12 15:23:27'),
(32,'CNCI','CNCI1','','','CNCI@gmail.com','','/uploads/logos/logo-1768231486768-679624383.png','Semestre','2026-01-12 15:24:46','2026-01-12 15:24:46'),
(33,'Universidad de Atenas Queretaro','Atenas1','','','AtenasQro@gmail.com','','/uploads/logos/logo-1768231524811-309485037.png','Semestre','2026-01-12 15:25:24','2026-01-12 15:25:24'),
(34,'Universidad Real de Querétaro','RealQro1','','','RealQro1@gmail.com','','/uploads/logos/logo-1768231733645-409063523.svg','Semestre','2026-01-12 15:28:53','2026-01-12 15:28:53'),
(35,'New Element','NewElementQro1','','','NewElementQro1@gmail.com','','/uploads/logos/logo-1768231868735-842997067.png','Semestre','2026-01-12 15:31:08','2026-01-12 15:31:08');
...
(78,'empresa1','empresa@gmail.com','$2b$10$Qzz3IhmmYqujE7NUCfaMVOT4c94mKRDRzeT3.UZHDzHi75UvLUvje','admin_empresa','activo',NULL,NULL,'2026-02-18 17:49:52','2026-02-18 17:57:15',NULL,1);
...
INSERT INTO `vinculacion_empresa_alumno` VALUES
(4,1,73,'Finalizado',1,'2026-02-19 17:16:17','2026-02-19 20:31:49');
...
-- Dump completed on 2026-02-20 14:45:08
